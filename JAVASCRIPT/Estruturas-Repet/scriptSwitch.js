const usuario = { nome: "Daniel", idade: 29, time: "Botafogo" }; // aqui vai o time para switch case  não esquecer o break ao final de cada um, e por fim coloacar o comportamento padrão.
...
switch (usuario.time) {
  ...
  case "Corinthians":
    ...
    break;
  default: //  comportamento padrão caso enhum case for atendido
